    ...
    <div class="nk-block-head nk-block-head-sm">
        <div class="nk-block-between">
            <div class="nk-block-head-content">
                <h4 class="nk-block-title page-title">Employee Dashboard</h4>
                ...
                <div class="card" id="leave_bank">
                    <div class="nk-ecwg nk-ecwg6">
                        <div class="card-inner">
                            <div class="card-title-group">
                                <div class="card-title">
                                    <h6 class="title">My Leave Balance</h6>
                                </div>
                            </div>
                            <div class="data">
                                <div class="data-group">
...
@section('scripts')
    <script>
        ...
        var data = "" + $('#leaveBankContent').html();
        var fcPopover = new bootstrap.Popover({
            title: 'Leave Bank Balance',
            content: data ? data : '',
            placement: 'top',
            html:true,
